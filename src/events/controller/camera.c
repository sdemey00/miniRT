...
/*   Updated: 2025/11/20 11:05:38 by mmichele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_bool	handle_left_js(struct s_ctx *c, const struct js_event *e)
{
	...
	vec_isum(&c->s.camera.pos, vec_scal(c->s.camera.dir, -a.y / 10));
	vec_isum(&c->s.camera.pos, vec_scal(c->s.camera.right, a.x / 10));
